...
OUTPUT;
        ...
        try {
            ...
            $output_html .= '<div class="error">' . print_r($exception) . '</div>';
        }
        $output_html .= <<<OUTPUT
</code>
...
<section>
    ...
    <p>The recursive function itself is protected and be accessesed with the static function PutFieldsOnArray::excecute() which only takes NDminArrays as arguments: </p>
